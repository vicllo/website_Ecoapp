...
<div id="interblockinscr">
	...
	<div id="blockcentrale">
		<h1 style="color: #009f3c;border-radius: 10px 10px 10px 10px;border: 5px double black;width: 333px;margin: auto;margin-top: 20px;">Missions permanentes</h1>

		<center id="entryimg">

			<div id="gere2carre">
				<div id="carreDconnect">
					<h2> Venir au lycée à pieds </h2>
					<div id="imagepade">
						<img src="img/imgMission/U3.png" style="width: auto;height: 200px;margin: 10px;">
					</div>
					<form method="post">
						<?php if($_SESSION['cooldown1'] == DateTime-24:00:00){ ?>
